...
sealed class Bytecode {
    ...
    data class IntArg(val code: Int, val arg: Int) : Bytecode() {
        override fun toString(): String = OPCODE_NAMES[code] + " " + arg
    }
    ...
    data class Call(val code: Int, val owner: String, val method: Method, val isInterface: Boolean) : Bytecode() {
        override fun toString(): String = "${OPCODE_NAMES[code]} $owner.${method.name}(${method.parameters})"
    }

    companion object {
        val OPCODE_NAMES = listOf("nop", "aconst_null", "iconst_m1", "iconst_0", "iconst_1", "iconst_2", "iconst_3", "iconst_4",
                ...
                "invokestatic", "invokeinterface", "<UNKNOWN>", "new", "newarray", "anewarray", "arraylength", "athrow", "checkcast",
                "instanceof", "monitorenter", "monitorexit", "wide", "multianewarray", "ifnull", "ifnonnull", "goto_w",
                "jsr_w", "breakpoint", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>",
                "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>",
                "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>",
                "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>",
                "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>",
                "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>",
                "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "<UNKNOWN>", "impdep1", "impdep2")
